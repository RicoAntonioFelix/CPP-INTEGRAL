...
public:
	 ...
	 */
	Integral<T> operator ++(int) noexcept {
	 ...
	 */
	const char* toRadix(std::size_t radix) const noexcept {
...
private:
	 ...
	 */
	Integral<T>& checkAndAssign(const Integral<T>& carbon_copy)
	                            noexcept {
		if (this != &carbon_copy)
